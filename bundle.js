...
;// CONCATENATED MODULE: ./src/modules/startpage.js
function startPage() {
  const {
    body
  } = document;
...
;// CONCATENATED MODULE: ./src/modules/displayhideeditpopup.js
...
;// CONCATENATED MODULE: ./src/modules/todolistedit.js
...
;// CONCATENATED MODULE: ./src/modules/todolistchecked.js
/* eslint-disable eqeqeq */
...
;// CONCATENATED MODULE: ./src/modules/displayhidedetails.js
...
;// CONCATENATED MODULE: ./src/modules/rendertodolist.js
...
const newArray = (/* unused pure expression or super */ null && ([]));
function renderTodoList(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    const dateFormatted = format(parseISO(todo.dueDate, "yyyy-MM-dd"), "yyyy-MM-dd");
...
;// CONCATENATED MODULE: ./src/modules/loadpageprojects.js
...
;// CONCATENATED MODULE: ./src/modules/renderproject.js
/* eslint-disable no-plusplus */
...
;// CONCATENATED MODULE: ./src/modules/projectvalidation.js
/* eslint-disable no-plusplus */
...
;// CONCATENATED MODULE: ./src/modules/projectbuttonfunctions.js
...
;// CONCATENATED MODULE: ./src/modules/projectFormActions.js
...
;// CONCATENATED MODULE: ./src/modules/projectformcancel.js
...
;// CONCATENATED MODULE: ./src/modules/projectpopup.js
...
call(); */
;// CONCATENATED MODULE: ./src/modules/todolist.js
...
;// CONCATENATED MODULE: ./src/modules/formvalidation.js
/* eslint-disable no-plusplus */
...
;// CONCATENATED MODULE: ./src/modules/buttonfunctions.js
/* eslint-disable import/no-mutable-exports */
...
function buttonFunctions() {
  ...
  const dueDate = format(parseISO(document.querySelector("#duedate").value, "yyyy-MM-dd"), "yyyy-MM-dd");
...
;// CONCATENATED MODULE: ./src/modules/formActions.js
...
;// CONCATENATED MODULE: ./src/modules/formcancel.js
function cancelForm() {
  const content = document.querySelector(".content");
  const popup = document.querySelector(".popup");
  document.getElementById("popupTitle").value = "";
...
;// CONCATENATED MODULE: ./src/modules/displayhidepopup.js
...
;// CONCATENATED MODULE: ./src/modules/createProject.js
...
;// CONCATENATED MODULE: ./src/modules/duetoday.js
...
;// CONCATENATED MODULE: ./src/modules/inboxpage.js
...
;// CONCATENATED MODULE: ./src/modules/upcomingpage.js
/* eslint-disable no-plusplus */
...
;// CONCATENATED MODULE: ./src/modules/sidepanel.js
...
function sidePanelFunction() {
  ...
  today.addEventListener("click", dueToday);
