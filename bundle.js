...
function buttonFunctions() {
  ...
  const dueDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_4__["default"])(
    (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_5__["default"])(document.querySelector("#duedate").value, "yyyy-MM-dd"),
    "yyyy-MM-dd"
  );
  ...
  if (title === "" && dueDate.valueOf().isNaN) {
    ...
    console.log(_localstorage__WEBPACK_IMPORTED_MODULE_3__.existingTasks);
    const filtering = _localstorage__WEBPACK_IMPORTED_MODULE_3__.existingTasks.filter((el) => el.title !== ""); // first if statement doesnt work if picking from array.. need to filter out all elements with an empty title because remember the date would still show up as invalid, bringing issues
...
function taskPopUp() {
  ...
  projectPicker.setAttribute("change", _formvalidation__WEBPACK_IMPORTED_MODULE_1__["default"]);
...
function renderTodoList(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    const todoListDueDate = document.createElement("div");
    todoListDueDate.classList.add("todoListDueDate");
    const dateFormatted = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(
      (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_2__["default"])(todo.dueDate, "yyyy-MM-dd"),
      "yyyy-MM-dd"
    );
