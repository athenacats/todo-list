...
function mainContainer() {
  ...
  editCancelButton.addEventListener("click", _formcancel__WEBPACK_IMPORTED_MODULE_3__["default"]);
...
function todoListEditButton(event) {
  ...
  if (matchingTask) {
    ...
    (0,_displayhidepopup__WEBPACK_IMPORTED_MODULE_0__["default"])();
