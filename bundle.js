...
function buttonFunctions() {
  ...
  if (title === "" && !dueDate.valueOf().isNaN) {
    ...
    console.log(_todolist__WEBPACK_IMPORTED_MODULE_1__.todos.sort((a, b) => a.dueDate - b.dueDate));
