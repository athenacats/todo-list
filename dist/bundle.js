...
function buttonFunctions() {
  ...
  if (title === "" && !dueDate.valueOf().isNaN) {
    ...
    _todolist__WEBPACK_IMPORTED_MODULE_1__.todos.filter((item) => item);

    const arr = _todolist__WEBPACK_IMPORTED_MODULE_1__.todos.sort((a, b) => a.dueDate - b.dueDate);
