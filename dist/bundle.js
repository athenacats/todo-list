...
/* harmony export */ });
/* harmony import */ var _buttonfunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./buttonfunctions */ "./src/modules/buttonfunctions.js");
/* harmony import */ var _rendertodolist__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rendertodolist */ "./src/modules/rendertodolist.js");
...
function inboxPage() {
  ...
  upcomingTodos.innerHTML = "";
  (0,_rendertodolist__WEBPACK_IMPORTED_MODULE_1__["default"])(_buttonfunctions__WEBPACK_IMPORTED_MODULE_0__.arr);
  const inbox = document.querySelector(".inboxPage");
...
function renderTodoList(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    todoListDelete.addEventListener("click", (event) => {
      ...
      arr.splice(index, 1);
      renderTodoList(arr);
      (0,_localstorage__WEBPACK_IMPORTED_MODULE_1__.removeTask)();
    });
    todoListItem.appendChild(todoListDelete);
  }
}
